    ...
    <section className="kyc">
      <div className="kyc__wrapper">
        <div className="kyc__heading">
          <h2>KYC GUIDE</h2>
          <p>
            In order to be verified by the Buffet FINANCE <br />
        ...
        <div className="kyc__content">
          <div className="kyc__content-poi">
            ...
            <h4>1.All 4 corners of the document must be shown;</h4>
            <h4>
            ...
            <h2>Notes</h2>
            <p>
              As part of regulatory requirements, clients are required to
              provide National Client Identifier (“NCI”), and Tax Identification
              Number (“TIN”) which may be included within either of the
              above-mentioned documents. Based on client(s)’ nationality,
          ...
          <div className="kyc__content-por">
            ...
            <div className="kyc__content-single-info">
              <div className="kyc__content-single-info-heading">
                <h4>1. Utility Bill </h4>
                <p>
                  Electricity Bill, Water Bill, Gas Bill, Landline Telephone
                  Bill, Internet Bill, Local Authority Tax Bill or any other
                  utility bill meeting these requirements:
                </p>
              </div>
              <ul>
                <li>
